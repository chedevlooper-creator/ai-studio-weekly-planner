    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === 'ghost' && 'border border-white/[0.08] bg-white/[0.03] text-zinc-300 hover:border-white/[0.15] hover:bg-white/[0.06] hover:text-white',
          variant === 'danger' && 'bg-rose-500/10 border border-rose-500/20 text-rose-400 hover:bg-rose-500/20 hover:text-rose-300',
          variant === 'icon' && 'text-zinc-500 hover:bg-white/[0.08] hover:text-white',
          // Sizes
