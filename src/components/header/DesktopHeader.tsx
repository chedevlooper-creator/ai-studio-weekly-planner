import { Download, Upload, LogOut, Zap, User2, Sun, Moon } from 'lucide-react';
    ...
    <div className="hidden sm:flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5">
          <div className="relative flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-accent to-emerald-700 shadow-[0_2px_16px_rgba(16,185,129,0.35)]">
          ...
          <div>
            ...
            <p className="text-[11px] font-medium text-zinc-500 tracking-wide">Görev Takip Sistemi</p>
          </div>
          {/* Week badge */}
          <span className="ml-1 hidden md:inline-flex items-center rounded-lg border border-white/[0.06] bg-white/[0.025] px-2.5 py-1 text-[11px] font-semibold text-zinc-400">
            Haftalık Plan
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {user && (
            <span className="hidden lg:flex items-center gap-2 rounded-lg border border-white/[0.06] bg-white/[0.025] px-3 py-1.5 text-xs text-zinc-400">
          ...
          {user && (
            <button
              type="button"
              onClick={onSignOut}
              className="btn-ghost !py-1.5 !px-3 !text-xs !text-zinc-500 hover:!text-red-400 hover:!border-red-500/20"
              aria-label="Çıkış"
            >
